...
var or__6207__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__6207__auto__)){
return or__6207__auto__;
} else {
var or__6207__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__6207__auto____$1)){
return or__6207__auto____$1;
} else {
var or__6207__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__6207__auto____$2)){
return or__6207__auto____$2;
} else {
var or__6207__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__6207__auto____$3)){
return or__6207__auto____$3;
} else {
...
var n__7121__auto__ = a.length;
var i = (0);
while(true){
if((i < n__7121__auto__)){
var c_12199 = (a[i]);
if(cljs.core.truth_((c_12199["cljsIsDirty"]))){
(c_12199["forceUpdate"])();
} else {
}
...
var G__12202 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__12202) : reagent.impl.batching.next_tick.call(null,G__12202));
}
});
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__6813__auto__,writer__6814__auto__,opt__6815__auto__){
return cljs.core._write(writer__6814__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__12204 = c;
var G__12204__$1 = (((G__12204 == null))?null:(G__12204["props"]));
if((G__12204__$1 == null)){
return null;
} else {
return (G__12204__$1["argv"]);
}
});
...
var G__12206_12207 = (c["cljsRatom"]);
if((G__12206_12207 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12206_12207);
}
