...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__6813__auto__,writer__6814__auto__,opt__6815__auto__){
return cljs.core._write(writer__6814__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__6207__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__6207__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__6207__auto__)){
return or__6207__auto__;
} else {
...
var G__12307 = o;
(G__12307[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_12311 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_12311))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_12311)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__6195__auto__ = (node === document.activeElement);
if(and__6195__auto__){
var and__6195__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
...
if(cljs.core.truth_((function (){var and__6195__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__12314 = jsprops;
(G__12314["defaultValue"] = value);

(G__12314["onChange"] = ((function (G__12314,v,value,on_change){
return (function (p1__12312_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12312_SHARP_);
});})(G__12314,v,value,on_change))
);
...
var vec__12316 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12316,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12316,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12316,(2),null);
...
var temp__4659__auto__ = (function (){var G__12320 = cljs.core.meta(v);
if((G__12320 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__12320);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__12322_12323 = v;
var G__12322_12324__$1 = (((G__12322_12323 == null))?null:reagent.impl.template.key_from_vec(G__12322_12323));
if((G__12322_12324__$1 == null)){
} else {
(jsprops["key"] = G__12322_12324__$1);
}
...
var G__12328 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12328) : reagent.impl.template.as_element.call(null,G__12328));
} else {
var p = (function (){var temp__4659__auto__ = (function (){var G__12329 = cljs.core.meta(argv);
if((G__12329 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__12329);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__12330 = (((jsprops == null))?{}:jsprops);
(G__12330["key"] = key);
...
var G__12331 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12331;
continue;
}
} else {
...
var n__7121__auto___12332 = a.length;
var i_12333 = (0);
while(true){
if((i_12333 < n__7121__auto___12332)){
(a[i_12333] = reagent.impl.template.as_element((a[i_12333])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7121__auto___12335 = a.length;
var i_12336 = (0);
while(true){
if((i_12336 < n__7121__auto___12335)){
var val_12337 = (a[i_12336]);
if((cljs.core.vector_QMARK_(val_12337)) && ((reagent.impl.template.key_from_vec(val_12337) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12336] = reagent.impl.template.as_element(val_12337));
...
if(cljs.core.truth_((function (){var and__6195__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__6195__auto__){
return (ctx["no-key"]);
} else {
return and__6195__auto__;
...
var G__12340 = (cljs.core.count(argv) - first_child);
switch (G__12340) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12340){
